"""
Django settings for lucky_feather_dev_58172 project.
...
ROOT_URLCONF = 'lucky_feather_dev_58172.urls'
...
WSGI_APPLICATION = 'lucky_feather_dev_58172.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_feather_dev_58172 API",
    "DESCRIPTION": "API documentation for lucky_feather_dev_58172 App",
    "VERSION": "v1",
}
